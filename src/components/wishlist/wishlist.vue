                ...
                <el-col :xs="12" :sm="12" :md="8" :lg="8" v-for="(pDet,index) in wishlistArr"  >
                  <div >
                    <div class="grid-content pa-2" >
                      <a class="prod_image" @click="$router.push({path:`/particularProduct/${pDet.key}`,query:{prodDet:JSON.stringify(pDet)}})">
                        <img :src="pDet.pBasicDetail.pPicUrl" style="height:286px "  alt="product">
                      </a>
                      <div class="prod_cont" @click="$router.push({path:`/particularProduct/${pDet.key}`,query:{prodDet:JSON.stringify(pDet)}})">
                      ...
                      <div class="prod_misc" @click="$router.push({path:`/particularProduct/${pDet.key}`,query:{prodDet:JSON.stringify(pDet)}})">
